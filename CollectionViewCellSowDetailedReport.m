//
//  CollectionViewCellSowDetailedReport.m
//  Collectionview
//
//  Created by Venturelabour on 04/04/16.
//  Copyright © 2016 Venturelabour. All rights reserved.
//

#import "CollectionViewCellSowDetailedReport.h"

#define NUMBEROFCOLUMNS 4
@interface CollectionViewCellSowDetailedReport ()
@property (strong, nonatomic) NSMutableArray *itemAttributes;
@property (strong, nonatomic) NSMutableArray *itemsSize;
@property (nonatomic, assign) CGSize contentSize;
@end

@implementation CollectionViewCellSowDetailedReport
